...
class PagelowController extends Controller
{
    function show(){
        $data['lowongan'] = Lowongan::all();
        return view('page.lowongan.show',$data);
    }
    ...
    function add(){
        ...
        return view('page.form_lowongan',$data);
    }
    function create(Request $request){ 
        ...
        return redirect()->route('page.lowongan.show');
    }
